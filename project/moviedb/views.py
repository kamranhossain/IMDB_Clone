...
from project.moviedb.forms import (
    VoteForm,
    MovieImageForm)
from project.moviedb.mixins import CachePageVaryOnCookieMixin
from project.moviedb.models import (
    Movie,
    Person,
    Vote
)
...
class TopMovies(ListView):
    template_name = 'moviedb/top_movies_list.html'
